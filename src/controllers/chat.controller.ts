...
export const getRecentChats = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
    const currentUserId = req.user?._id;
...
// @access  Private
export const getSupportAgents = async (_req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
